...
export const routes: Routes = [
  ...
  // Student Portal (Solo lectura con token)
  {
    ...
    loadComponent: () => import('./features/student-portal/student-login/student-login.component').then(m => m.StudentLoginComponent)
  },
  {
  ...
  // Dashboard Routes (Protegidas)
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import('./features/schedule/schedule-calendar/schedule-calendar.component').then(m => m.ScheduleCalendarComponent)
      },
      {
        path: 'settings',
