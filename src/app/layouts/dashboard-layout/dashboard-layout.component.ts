            ...
            <div class="flex items-center gap-3">
              ...
              <div class="relative" #notificationsContainer>
                <button 
                  ...
                  class="p-2.5 rounded-xl hover:bg-surface-100 dark:hover:bg-surface-800 relative transition-all duration-200 text-surface-700 dark:text-surface-300 hover:text-primary-700 border border-transparent hover:border-surface-200 dark:hover:border-surface-700"
